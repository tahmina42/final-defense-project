...
<div class="container send">
	<div class="row">
		<div class="col-lg-12">
		<center><b><h3 class='text-primary'>Send Email Reminder</h3></b></center>
			<div class="search">
				<form method="post">
		...
		<table class="table table-striped">
						<tr style='border-bottom:1px solid gray;' class="headtab">
							<td>Patient Name</td>
												...
												{	
													...
													{	
														...
														echo "<td style='border-bottom:1px solid gray;'><div class='update-link2'>
																		<a href=\"confirmmail.php?id=$res[p_id]\">Send</a> 
																</div></td>";
